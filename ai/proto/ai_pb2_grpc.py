...
class AIServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Summarize = channel.unary_unary(
            "/AIService/Summarize",
            request_serializer=ai__pb2.SummaryRequest.SerializeToString,
            response_deserializer=ai__pb2.SummaryResponse.FromString,
...
def add_AIServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "Summarize": grpc.unary_unary_rpc_method_handler(
            servicer.Summarize,
            request_deserializer=ai__pb2.SummaryRequest.FromString,
            response_serializer=ai__pb2.SummaryResponse.SerializeToString,
        ),
    }
...
class AIService(object):
    ...
    def Summarize(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/AIService/Summarize",
            ai__pb2.SummaryRequest.SerializeToString,
            ai__pb2.SummaryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
